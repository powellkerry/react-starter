    ...
    _createClass(Icon, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('use', { xlinkHref: '/si/static/assets/icons.svg#' + this.props['icon-name'] })
            );
        }
    }]);
...
var Anchor = function (_Component) {
    ...
    _createClass(Anchor, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'a',
                { className: _style2.default.anchor + ' ' + (this.props.isButton ? _style2.default.anchor__button : '') + ' ' + (this.props.isLightButton ? _style2.default.anchor__button + ' ' + _style2.default.anchor__button__light : '') + ' ' + (this.props.className || ''), href: this.props.url },
                this.props.icon ? _react2.default.createElement(
                    'span',
                    { className: _style2.default['anchor__icon_wrapper'] + ' ' + (this.props.button ? _style2.default.anchor__icon_wrapper_block : '') },
                    _react2.default.createElement(
                        'span',
                        { className: _style2.default.anchor__icon + ' ' + (this.props.button ? _style2.default.anchor__icon__button : '') },
                        _react2.default.createElement(_icon2.default, _extends({ className: '' + _style2.default.anchor__icon__icon }, this.props.icon))
                    )
                ) : '',
                _react2.default.createElement(
                    'span',
...
var _attributeToggler = __webpack_require__(23);

var _attributeToggler2 = _interopRequireDefault(_attributeToggler);

var _makeFit = __webpack_require__(24);
...
module.exports = {"site-navigation":"site-navigation","site-navigation_seminary":"site-navigation_seminary","site-navigation_institute":"site-navigation_institute","site-navigation_church_education":"site-navigation_church_education","site-navigation__site_name":"site-navigation__site_name","site-navigation__site_name_seminary":"site-navigation__site_name_seminary","site-navigation__site_name_church_education":"site-navigation__site_name_church_education","link--active":"link--active","site-navigation__menu_toggle":"site-navigation__menu_toggle","icon":"icon","site-navigation__menu":"site-navigation__menu","site-navigation__link--right":"site-navigation__link--right","site-navigation__link":"site-navigation__link","site-navigation_mobile":"site-navigation_mobile"};
...
var _siteNavigation = __webpack_require__(21);
...
var SiteNavigation = function (_Component) {
    _inherits(SiteNavigation, _Component);

    function SiteNavigation() {
        _classCallCheck(this, SiteNavigation);

        return _possibleConstructorReturn(this, (SiteNavigation.__proto__ || Object.getPrototypeOf(SiteNavigation)).apply(this, arguments));
    }

    _createClass(SiteNavigation, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            (0, _siteNavigation2.default)();
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'nav',
                { className: _style2.default['site-navigation'] + ' ' + _style2.default['site-navigation_' + this.props['site-context'] || 'seminary'] + ' ' + (this.props.className || ''), role: 'navigation' },
                _react2.default.createElement(
                    'a',
                    { className: _style2.default['site-navigation__site_name'] + ' ' + _style2.default['site-navigation__site_name_' + this.props['site-context'] || 'seminary'], href: this.props.homeLink.url },
                    this.props.homeLink.text
                ),
                _react2.default.createElement(
                    'button',
                    { className: '' + _style2.default['site-navigation__menu_toggle'] },
                    _react2.default.createElement(_icon2.default, { 'icon-name': 'more' })
                ),
                _react2.default.createElement(
                    'div',
                    { className: '' + _style2.default['site-navigation__menu'] },
                    this.props.links.map(function (link, idx) {
                        return _react2.default.createElement(_anchor2.default, _extends({ key: idx }, link, { className: _style2.default['site-navigation__link'] + ' ' + (link.className || '') }));
                    })
                )
            );
        }
...
// removed by extract-text-webpack-plugin
module.exports = {"anchor":"anchor","anchor__icon_wrapper":"anchor__icon_wrapper","anchor__icon_wrapper_block":"anchor__icon_wrapper_block","anchor__icon":"anchor__icon","anchor__icon__button":"anchor__icon__button","anchor__icon__button__icon":"anchor__icon__button__icon","anchor__icon__button__text":"anchor__icon__button__text","anchor__button":"anchor__button","anchor__button__light":"anchor__button__light","icon":"icon"};
...
// removed by extract-text-webpack-plugin
module.exports = {"icon":"icon","icon__facebook":"icon__facebook","icon__twitter":"icon__twitter","icon__pinterest":"icon__pinterest","icon__google_plus":"icon__google_plus","icon__instagram":"icon__instagram","icon__youtube":"icon__youtube","icon__rss_feed":"icon__rss_feed","icon__ok":"icon__ok","icon__vk":"icon__vk"};
